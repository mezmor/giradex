// Credit simple-statistics
// https://github.com/simple-statistics/simple-statistics
// adapted via https://gist.github.com/tmcw/4977508
...
// allow upper and lower bounds to be classified
jenks_wrapper = function(data, n_classes) {
    let data_cpy = data.slice();
    data_cpy.unshift(data[0]);
    data_cpy.push(data[data.length-1]);
    return jenks(data_cpy, n_classes+1).reverse().slice(1, n_classes+1);
}